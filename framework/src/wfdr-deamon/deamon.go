...
func (m *ModuleSrv) Start(name *string, ret *int) os.Error {
...
func (m *ModuleSrv) Stop(name *string, ret *int) os.Error {
...
func (m *ModuleSrv) Status(name *string, running *bool) os.Error {
	//var isrunning bool
	//*running = isrunning
