...
func (o *OpenID) GetUrl() (string, error) {
	o.normalization()
	err := o.discovery()
	if err != nil {
		return "", err
...
func (o *OpenID) Verify() (grant bool, err error) {
	grant = false
	err = nil
...
func (o *OpenID) VerifyDirect() (grant bool, err error) {
	grant = false
	err = nil
	...
	if r != nil {
		...
		err = errors.New("No response from POST verification")
		return
	}
