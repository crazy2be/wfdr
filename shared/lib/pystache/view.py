...
class View(object):
    ...
    template_path = 'tmpl/desktop/shared'
    ...
    def _load_template(self):
        f = codecs.open(self.template_file, encoding='utf-8', mode='r')
        try:
            template = f.read()
    ...
    def render(self, encoding=None):
		print "Template: {0}".format(self.template_file)
		#if self.template_file:
		#	self.template_path = os.path.dirname(self.template_file)
